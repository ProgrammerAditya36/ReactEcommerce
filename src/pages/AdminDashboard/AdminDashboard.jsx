    ...
    return (
        <div>
            ...
            <div className="top mb-5 mt-5 px-5">
                <div className="rounded-lg border border-pink-100 bg-pink-50 py-5">
                    ...
                    <Tabs>
                        <TabList className="-m-4 flex flex-wrap justify-center text-center">
                            ...
                            <Tab className="w-full cursor-pointer p-4 sm:w-1/2 md:w-1/3">
                                <div className="rounded-xl border border-pink-100 bg-pink-50 px-4 py-3 hover:bg-pink-100">
                                    <div className="mb-3 inline-block h-12 w-12 text-pink-500">
                                        <svg
                                    ...
                                    <h2 className="title-font fonts1 text-3xl font-medium text-pink-400">
                                        10
                                    </h2>
